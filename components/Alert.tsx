...
export default function Alert({ level = 'info', children }: {level: Levels, children: ReactNode }) {
  const levels = {
    success: {
  ...
  return (
    <div className={`px-3 py-1 rounded-lg border-2 ${levels[level].classes} text-left flex items-center`}>
      <span>
